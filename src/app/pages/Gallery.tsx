...
// Mock Instagram photos - In a real app, these would come from Instagram API
const instagramPhotos = [
  {
    id: 1,
    url: "https://images.unsplash.com/photo-1544427920-c49ccfb85579?w=400&h=400&fit=crop",
    username: "user1",
    likes: 45,
  },
  {
    id: 2,
    url: "https://images.unsplash.com/photo-1564758866116-8e8563f8ac12?w=400&h=400&fit=crop",
    username: "user2",
    likes: 67,
  },
  {
    id: 3,
    url: "https://images.unsplash.com/photo-1551538827-9c037cb5a7e2?w=400&h=400&fit=crop",
    username: "user3",
    likes: 89,
  },
  {
    id: 4,
    url: "https://images.unsplash.com/photo-1622597468042-72070d90746b?w=400&h=400&fit=crop",
    username: "user4",
    likes: 120,
  },
  {
  ...
  {
    id: 6,
    url: "https://images.unsplash.com/photo-1527661591475-527312dd65f5?w=400&h=400&fit=crop",
    username: "user6",
    likes: 78,
  },
  {
  ...
  {
    id: 8,
    url: "https://images.unsplash.com/photo-1514649923863-ceaf75b7ec40?w=400&h=400&fit=crop",
    username: "user8",
    likes: 103,
  },
  {
    id: 9,
    url: "https://images.unsplash.com/photo-1516594798947-e65505dbb29d?w=400&h=400&fit=crop",
    username: "user9",
    likes: 145,
  },
];
...
export function Gallery() {
  return (
    <div>
      {/* Gallery Header */}
      <section className="py-20 bg-gradient-to-br from-[#f78211] to-[#fdc101] text-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          <div className="inline-block mb-6">
            <Instagram size={64} className="text-white drop-shadow-lg" />
          </div>
          <h1
            className="text-5xl md:text-6xl mb-6 text-[#004042]"
            style={{ fontFamily: 'Righteous, sans-serif' }}
          >
            Apareça Aqui!
          </h1>
          <p className="text-xl text-[#004042] mb-4">
            Compartilhe seu momento com o Mate Carioca
          </p>
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full border-2 border-white/40">
            <span className="text-2xl" style={{ fontFamily: 'Righteous, sans-serif' }}>
              #matecariocafoz
            </span>
          </div>
        </div>
      ...
      {/* Instructions */}
      <section className="py-12 bg-[#fdfdfb]">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#fdc101]">
            <h2 className="text-2xl mb-6 text-center text-[#004042]" style={{ fontFamily: 'Righteous, sans-serif' }}>
              Como Participar
            </h2>
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                <div className="text-4xl mb-3">📸</div>
                <h3 className="text-lg mb-2 text-[#0c6938]" style={{ fontFamily: 'Righteous, sans-serif' }}>
                  1. Tire uma foto
                </h3>
                <p className="text-sm text-[#004042]/70">
                  Registre seu momento com o Mate Carioca
                </p>
              </div>
              <div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {instagramPhotos.map((photo, index) => (
              <div
                key={photo.id}
                className="relative group overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all aspect-square"
                style={{
              ...
              >
                <ImageWithFallback
                  src={photo.url}
                  alt={`Mate Carioca - ${photo.username}`}
                ...
                {/* Decorative Border */}
                <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#fdc101] transition-all duration-300 rounded-2xl pointer-events-none" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#0c6938] to-[#004042] text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2
            className="text-4xl md:text-5xl mb-6 text-[#fdc101]"
            style={{ fontFamily: 'Righteous, sans-serif' }}
          >
            Seja o Próximo!
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Compartilhe seu mate e faça parte da nossa comunidade carioca em Foz
          </p>
          <a
            href="https://instagram.com/matecariocafoz"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-4 rounded-full text-white font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
          >
            <Instagram size={24} />
            <span>Seguir @matecariocafoz</span>
          </a>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#fdfdfb]">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="rounded-3xl overflow-hidden shadow-2xl relative" style={{ height: '200px' }}>
            ...
            <div className="h-full flex items-center justify-center bg-[#0c6938]/80 backdrop-blur-sm relative z-10">
              <div className="text-center text-white px-4">
                <p className="text-3xl md:text-4xl mb-2" style={{ fontFamily: 'Righteous, sans-serif' }}>
                  🏖️ Vibes Cariocas 🥥
                </p>
                <p className="text-lg opacity-90">
                  Levando o Rio para onde você estiver
                </p>
              </div>
            </div>
          </div>
